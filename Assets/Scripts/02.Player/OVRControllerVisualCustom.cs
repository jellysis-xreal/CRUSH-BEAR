...
namespace Oculus.Interaction.Input.Visuals
{
    ...
    public class OVRControllerVisualCustom : MonoBehaviour
    {
        ...
        [SerializeField]
        private OVRControllerHelperCustom _ovrControllerHelper;
        ...
        public void InjectAllOVRControllerVisual(IController controller, OVRControllerHelperCustom ovrControllerHelper)
        {
        ...
        public void InjectAllOVRControllerHelper(OVRControllerHelperCustom ovrControllerHelper)
        {
